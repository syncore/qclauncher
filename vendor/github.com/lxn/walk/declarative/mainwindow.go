...
type MainWindow struct {
	...
	UseCustomWindowStyle bool       // added by syncore: 07/21/17
	CustomWindowStyle    uint32     // added by syncore: 07/21/17
}

func (mw MainWindow) Create() error {
	// the next 10 lines, added by syncore: 07/21/17
	var w *walk.MainWindow
	var err error
	if mw.UseCustomWindowStyle && mw.CustomWindowStyle != 0 {
		w, err = walk.NewStyledMainWindow(mw.CustomWindowStyle)
	} else {
