...
// SwitchToThisWindow added by syncore, 07/22/17
// see: https://github.com/lxn/walk/issues/223
func (wb *WindowBase) SwitchToThisWindow() {
	_, _, _ = syscall.Syscall(win.MustGetProcAddress(win.MustLoadLibrary("user32.dll"),
		"SwitchToThisWindow"),
		2,
		uintptr(wb.hWnd),
		1,
